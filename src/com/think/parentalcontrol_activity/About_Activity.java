...
public class About_Activity extends Activity implements OnLongClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		startService(new Intent(About_Activity.this, GpsSerivces.class));
	...
	private void createSecondTime(String title) {
		...
		final EditText usernameEditText = (EditText) view
		...
		final AlertDialog alertDialog = new AlertDialog.Builder(this)
				...
				.setNegativeButton("Cancel", null).setView(view).create();
						...
						if (usernameEditText.getText().toString().equals("")) {
							...
							if (password.equals(passwordEditText.getText()
									...
									&& username.equals(usernameEditText
											.getText().toString())) {
								startActivity(new Intent(About_Activity.this,
										HomeActivity.class));
								finish();
							} else {
	...
	private class GetParentNumber extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (!result.equals(WebserviceUtil.ERROR)) {
				if (!result.equals("")) {
					Log.d("NUMBER", "PARENT NUMBER " + result);
					PreferenceManager
							.getDefaultSharedPreferences(About_Activity.this)
	...
	private class CheckLogin extends AsyncTask<String, Void, String> {
		ProgressDialog dialog = new ProgressDialog(About_Activity.this);
